...
Using a variational approach, we will derive the ray equations and describe the modification necessary to extract the bound-state spectrum of a multicomponent wave equation through quantization.
The general theory prescribed in this chapter will form a basis for our study of elastic waves in the next chapter.
\\
}

The study of propagating waves is important to many disciplines.
A widely employed asymptotic method to solve wave problem is the WKB/semiclassical approximation, which is sometimes also referred to as the eikonal approximation, geometrical optics, etc.
