...
\begin{center*}
  ...
  \ifsustyle
    \relax
  \else
    \includegraphics{misc/sulogo.pdf}\\[1em]
  \fi
...
\ifsustyle
  % SU requires page number at the bottom for all prefatory pages.
...
\else
  \defbibnote{myprenote}{\hypersetup{allcolors=bs1}% without this, footnote link will be in nord11.
  ...
  \hypersetup{linkcolor=nord11} % color of back references
  \def\bibfont{\small}
