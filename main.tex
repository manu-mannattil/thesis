...
In the first problem, I consider the equilibrium thermal fluctuations of deformable mechanical frameworks, such as those used to model a plethora of soft few-body systems at the submicron scale, e.g., colloidal clusters, proteins, DNA origami, etc.
When the holonomic constraints in a framework cease to be linearly independent, singularities can appear in its configuration space.
At these singularities, the framework becomes energetically softer.
As a consequence, the framework's free-energy landscape is dominated by the neighborhoods of points that correspond to these singularities.
...
Here, using the semiclassical approximation for vector waves, I show that flexural, extensional, and shear waves form localized, bound states around points where the absolute curvature of the structure has a minimum.
